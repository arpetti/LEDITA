...
describe('Login Flow', function() {
	...
	it('Existing user can login', function() {
		...
		// Verify avatar is displayed in top nav
		expect(element('#userAvatarImage').attr('src')).toMatch('avatar/user4.png');
		expect(element('#userAvatarImage').css('display')).toBe("inline");
		expect(element('#defaultAvatarImage').css('display')).toBe("none");
